...
(* OASIS_START *)
(* DO NOT EDIT (digest: c785e9e5bac04387f96a6761fb0322db) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "Multi-stage programming in the typed-final (tagless-final) style";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "final-msp";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "lint"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "fact.ml"});
               Executable
                 ({
                     cs_name = "run_error";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\199\167\153\158n\175\003\n\154\1813\197O\016\139/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
